...
- [Checking Files](guide/checking-files.md)
- [Checking Directories](guide/checking-directories.md)
- [CI/CD Integration](guide/ci-cd-integration.md)
- [Stdin and Pipes](guide/stdin-pipes.md)

# Analyzers

- [Overview](analyzers/overview.md)
...
- [Built-in Rules](rules/built-in-rules.md)

# Configuration

- [Configuration File](configuration/config-file.md)
- [Known Packages](configuration/known-packages.md)
- [Vowignore File](configuration/vowignore.md)
